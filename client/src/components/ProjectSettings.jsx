                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <select value={formData.status} onChange={(e) => setFormData({ ...formData, status: e.target.value })} className={inputClasses + " bg-white dark:bg-slate-900 dark:text-gray-200 dark:hover:bg-slate-800 transition-colors"} >
                        ...
                        <div className="space-y-2">
                            ...
                            <select value={formData.priority} onChange={(e) => setFormData({ ...formData, priority: e.target.value })} className={inputClasses + " bg-white dark:bg-slate-900 dark:text-gray-200 dark:hover:bg-slate-800 transition-colors"} >
