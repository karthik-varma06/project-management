...
export default function CreateTaskDialog({ showCreateTask, setShowCreateTask, projectId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const {data} = await api.post('/api/tasks', {...formData, projectId, origin: window.location.origin}, {headers: { Authorization: `Bearer ${await getToken()}` }})
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <select value={formData.type} onChange={(e) => setFormData({ ...formData, type: e.target.value })} className="w-full rounded bg-white dark:bg-slate-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-gray-200 text-sm mt-1 dark:hover:bg-slate-800 transition-colors" >
                        ...
                        <div className="space-y-1">
                            ...
                            <select value={formData.priority} onChange={(e) => setFormData({ ...formData, priority: e.target.value })} className="w-full rounded bg-white dark:bg-slate-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-gray-200 text-sm mt-1 dark:hover:bg-slate-800 transition-colors" >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <select value={formData.assigneeId} onChange={(e) => setFormData({ ...formData, assigneeId: e.target.value })} className="w-full rounded bg-white dark:bg-slate-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-gray-200 text-sm mt-1 dark:hover:bg-slate-800 transition-colors" >
                        ...
                        <div className="space-y-1">
                            ...
                            <select value={formData.status} onChange={(e) => setFormData({ ...formData, status: e.target.value })} className="w-full rounded bg-white dark:bg-slate-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-gray-200 text-sm mt-1 dark:hover:bg-slate-800 transition-colors" >
